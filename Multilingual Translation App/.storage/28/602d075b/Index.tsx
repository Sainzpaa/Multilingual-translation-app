...
import { Plus, Languages, Globe, Zap, Mic } from "lucide-react";
...
export default function Index() {
  ...
  const handleVoiceTranslation = (sourceText: string, translatedText: string, fromLang: string, toLang: string) => {
    const result: TranslationResult = {
      id: Date.now().toString(),
      sourceText,
      translatedText,
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-sm text-blue-100">Speak & listen naturally</p>
              </div>
              <div className="flex flex-col items-center gap-2">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-semibold text-gray-900">
                {voiceMode ? "Voice Conversation" : "Text Translation"}
              </h2>
              <div className="flex items-center gap-2">
                <Button
            ...
            {voiceMode ? (
              ...
              <VoiceTranslationCard
                id="voice-1"
                fromLang={translationPairs[0]?.fromLang || "en"}
                toLang={translationPairs[0]?.toLang || "hi"}
                onFromLangChange={(lang) => updateTranslationPair("1", { fromLang: lang })}
                onToLangChange={(lang) => updateTranslationPair("1", { toLang: lang })}
                onSwap={() => swapLanguages("1")}
              ...
              <>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600">Text Translation Pairs</span>
                  <Button onClick={addTranslationPair} className="gap-2" size="sm">
                    <Plus className="h-4 w-4" />
                    Add Pair
                  </Button>
                </div>
            ...
            <Card className="bg-gray-50 border-dashed">
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-500 mt-3 text-center">
                  Try saying "hello" or "how are you" for demo voice translations
                </p>
              </CardContent>
            </Card>
          </div>
